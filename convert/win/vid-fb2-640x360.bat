...
ffmpeg ^
	...
	-map 0:0 ^
	-map 1:0 ^
	-filter_complex "[2]scale=120:76[logo], [0][logo]overlay=50:20" ^
	-c:v libx264 ^
	-crf 23 ^
	-c:a aac ^
	-b:a 64k ^
...
echo file %scripts_path%\\video\\CA_Intro_640x360-30fps.mp4 > files_.txt
set file_name_with_quote=%1_mid.mp4
set file_name=%file_name_with_quote:"=%
echo file '%file_name%' >> files_.txt
echo file %scripts_path%\\video\\CA_Outro_640x360-30fps.mp4 >> files_.txt
